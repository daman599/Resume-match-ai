        ...
        <>
            {tips.length > 0 && (
                <motion.div initial={{ opacity: 0, filter: "blur(3px)" }}
                    ...
                    viewport={{ once: true }}
                    className="min-h-screen flex flex-col items-center justify-center px-4 sm:px-8 md:px-16 lg:px-24 my-20 w-full max-w-5xl mx-auto "
                >
                    <span className={`my-4 text-2xl sm:text-2xl ${plusJakarta.variable} font-medium text-[#0096FF] text-start sm:text-left`}>
